...
# === 右侧：HTML 气泡对话框 (核心修复：去除 f-string 缩进) ===
with col_right:
    st.markdown("### 🤖 智能咨询顾问")
    ...
    # 欢迎语
    if len(st.session_state.messages) == 0:
        # 使用单行或紧凑格式，避免 Markdown 将缩进识别为代码块
        chat_html += f"""<div class="chat-row bot"><img src="{AVATAR_BOT}" class="avatar"><div class="bubble bot">👋 您好！我是您的跨境医疗助手。<br><br>您可以问我：<br>1. “附近的<b>港大深圳医院</b>在哪里？”<br>2. “哪家牙科可以用<b>长者医疗券</b>？”</div></div>"""
